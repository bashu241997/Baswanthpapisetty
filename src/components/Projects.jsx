  ...
  const projects = [
    {
      ...
      tags: [{ name: "React", color: "text-blue-600" }, { name: "Next.js", color: "text-gray-600" }, { name: "TypeScript", color: "text-cyan-600" }],
    ...
    },
    {
      ...
      tags: [{ name: "React", color: "text-blue-600" }, { name: "Socket.io", color: "text-emerald-600" }, { name: "Node.js", color: "text-indigo-600" }],
    ...
    },
    {
      ...
      tags: [{ name: "Next.js", color: "text-gray-600" }, { name: "React", color: "text-blue-600" }, { name: "Tailwind CSS", color: "text-cyan-600" }],
    ...
    },
    {
      ...
      tags: [{ name: "React", color: "text-blue-600" }, { name: "TypeScript", color: "text-cyan-600" }, { name: "OpenWeather API", color: "text-amber-600" }],
