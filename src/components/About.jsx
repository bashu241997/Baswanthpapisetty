...
const About = () => {
  ...
  return (
    <div className="px-4 uppercase  h-full">
      ...
      <button className="block uppercase my-2 py-1 px-4 bg-[#94a3b8] text-[#333] font-bold rounded-[30px] mr-2 border-4 border-[#94a3b8]">
        resume
      </button>
    </div>
  );
