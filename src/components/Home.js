...
export default function HomeComponent() {
  return (
    <div
      id="home"
      className="grid p-8 min-h-full sm:grid-cols-2 capitalize text-slate-200 HomeData"
    >
      <div className="flex justify-center sm:pl-12 pl-2 flex-col">
        ...
        <a onClick={(e)=>anchor(e,"experince")} className="cursor-pointer py-2 px-12 rounded-full  mr-3 w-fit bg-sky-600 my-6">explore work</a>
        <div className="flex">
