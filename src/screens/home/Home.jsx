    ...
    <div id='home' className='py-8 flex flex-col sm:flex-row min-h-[95vh] text-primary justify-center items-center gap-4'>
      <div  id='home-leftcontainer' className='pl-6 sm:pl-0'> 
        ...
        <div className='flex pb-6'>
          <button className='bg-primary text-white uppercase rounded-[50px] py-3 w-[120px] font-bold mr-3'>About me</button>
          <button className='bg-background text-primary border-4 border-primary uppercase rounded-[50px] py-3 font-bold w-[120px] mr-3'>projects</button>
        </div>
      </div>
