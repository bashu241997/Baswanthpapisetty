...
export const ProjectCard = ({ name, description, tags, source_code_link, domain }) => (
  ...
  >
    ...
    <div className="p-6 flex flex-col flex-1">
      ...
      <div className="flex justify-between items-start mb-5">
        ...
        <div className="flex gap-1.5">
          <button 
            ...
            className="w-8 h-8 rounded-lg bg-gray-50 border border-gray-200/60 flex items-center justify-center text-gray-500 hover:text-slate-900 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all duration-200 cursor-pointer"
            title="Live Demo"
          >
      ...
      {/* Project Description */}
      <h3 className="text-[15px] font-bold text-slate-900 mb-2.5 group-hover:text-blue-600 transition-colors duration-300">
        {name}
      </h3>
