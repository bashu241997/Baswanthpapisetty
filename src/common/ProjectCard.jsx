...
export const ProjectCard = ({
  ...
  return (
      <div
        className="bg-exp-pattern bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-80 border dotted shadow-xl border-[#cccccc] p-4 text-[#364056]  p-[30px]  shadow-lg rounded-[20px] overflow-hidden w-[320px] sm:w-[350px] sm:h-[450px] scale-90 duration-300 hover:scale-100 w-full"
      >
        <div className="p-4 mt-2 min-h-[150px]">
          ...
          <p className="mt-2 text-[#364056] font-semibold text-[14px]">
            {description}
          </p>
        </div>
        <div
        ...
        >
          ...
          >
          <Globedisplay />
          <span className="px-2 text-[#364056] font-semibold text-[14px]">
            Visit Site
          </span>
          </div>
