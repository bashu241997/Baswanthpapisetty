export const ExperienceCard = ({ icon, experience, time }) => {
  return (
      <div className="bg-exp-pattern  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-80 border dotted border-[#cccccc] shadow-lg p-4 text-[#333333] rounded-[10px] p-[30px]">
        <div>
          ...
          <div className="flex pt-3 pl-[30px]">
            ...
            <p
              className="pl-[10px] flex items-center text-[18px] text-[#333333] "
              style={{ margin: 0 }}
            >
