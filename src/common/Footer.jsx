  ...
  return (
    <>
      <div className="flex mt-4 flex-wrap pt-[80px] justify-center items-center">
        <a
          href="#homer"
          className="px-3 scale-100 uppercase underline text-[#333333] text-[16px] p-3 font-medium hover:scale-110 duration-300"
        >
          home
        </a>
        <a
      ...
      <footer className="text-[#333] text-center font-bold text-sm bottom-[0px] w-full py-[25px]">
